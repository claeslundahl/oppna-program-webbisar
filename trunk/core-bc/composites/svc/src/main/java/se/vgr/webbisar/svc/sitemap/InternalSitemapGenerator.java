 ...
 */
package se.vgr.webbisar.svc.sitemap;
    ...
    public String generate(List<SitemapEntry> sitemapEntries) {
        ...
        for (SitemapEntry entry : sitemapEntries) {
            ...
            for (SitemapEntry.ExtraInformation extraInformation : entry) {
                output.append("<webbis:").append(extraInformation.getName()).append(">").append(
                        extraInformation.getValue()).append("</webbis:").append(extraInformation.getName())
                        .append(">\n");
            }
            output.append("</url>\n");
        }
