...
public class WebbisDaoTest {
	...
	public void testInsert() throws Exception {
		...
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		webbisDao.save(new Webbis("Kalle", "someId",Sex.Male, new BirthTime(2009,1,2,14,33),
		...
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		webbisDao.save(new Webbis("Gunnar", "someId", Sex.Male, new BirthTime(2009,1,4,0,0),
			       3453, 49, Hospital.OSTRA, "Göteborg", parents, images, "Lisa och Nisse",
			       "Ett meddelande", "email@email.se", "http://www.blog.se/mamma"));
		...
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		webbisDao.save(new Webbis("Kalle", "someOtherId",Sex.Male, new BirthTime(2009,1,2,14,34),
				       2345, 55, Hospital.KSS, "Mölndal" ,parents, images, "Johanna",
				       "Ett meddelande", "email@email.se", "http://www.blog.se/mamma"));
		...
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		Webbis webbis = new Webbis("Gunnar", "someId", Sex.Male, new BirthTime(2009,1,4,0,23),
			       3453, 49, Hospital.NAL, "Göteborg", parents, images, "Lisa och Nisse",
			       "Ett meddelande", "email@email.se", "http://www.blog.se/mamma");
		webbis.disable();
		...
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		images.add(new Image("http://somewhere.se/images/12343.jpg", "Detta är en fin bild"));
		webbisDao.save(new Webbis("Berra", "someOtherId", Sex.Male, new BirthTime(2009,1,5,0,24),
			       3453, 49, Hospital.MOLNDAL, "Göteborg", parents, images, "Lisa och Nisse",
			       "Ett meddelande", "email@email.se", "http://www.blog.se/mamma"));
