...
public class SearchResultPageBean implements Serializable {
    ...
    public SearchResultPageBean(SearchCriteriaBean searchCriteria, int numberOfHits, int pageNumber,
            boolean firstPage, boolean lastPage, List<SearchResultBean> webbisar) {
