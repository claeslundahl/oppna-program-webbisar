...
public class Webbis implements Serializable {
	...
	public Webbis(Long id, String name, String authorId, Sex sex,
			BirthTime birthTime, int weight, int length, Hospital hospital,
			String home, List<Name> parents, List<Image> images,
			String siblings, String message, String email, String homePage) {
		this(name, authorId, sex, birthTime, weight, length, hospital, home,
				parents, images, siblings, message, email, homePage);

		this.id = id;
	}

	public Webbis(String name, String authorId, Sex sex, BirthTime birthTime,
			int weight, int length, Hospital hospital, String home,
			List<Name> parents, List<Image> images, String siblings,
