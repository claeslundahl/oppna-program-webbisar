 ...
 * 
 */
public class WebbisSitemapCacheLoaderTest {

    private WebbisSitemapCacheLoader sitemapCacheLoader;
    ...
    public void setUp() throws Exception {
        ...
        sitemapCacheLoader = new WebbisSitemapCacheLoader(sitemapEntryLoader, "http://base.com");
    }

    /**
     * Test method for
     * {@link se.vgregion.webbisar.svc.sitemap.impl.WebbisSitemapCacheLoader#populateSitemapEntryCache(se.vgregion.sitemap.model.SitemapCache)}
     * .
     */
    @Test
    public final void testPopulateSitemapEntryCacheSitemapCache() {
        ...
        assertFalse("Should be no extra info", entry.iterator().hasNext());
    }
}
